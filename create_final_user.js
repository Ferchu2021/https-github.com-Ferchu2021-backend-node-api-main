...
console.log('🔧 Creando usuario final para MongoDB Atlas');
console.log('==========================================\n');

console.log('📋 Pasos para crear el usuario final:');
console.log('');
...
// URL con el usuario final
const finalMongoUrl = 'mongodb+srv://test:test123@cluster0.mhwnsc1.mongodb.net/backend-node-api?retryWrites=true&w=majority';

// Configuración del archivo .env
const envConfig = `# MongoDB Atlas
MONGO_URI=${finalMongoUrl}
...
const updateEnvFile = () => {
  try {
    ...
    console.log('✅ Archivo .env actualizado con usuario final!');
    console.log('\n🔗 Nueva URL de MongoDB Atlas:');
    console.log(`   mongodb+srv://test:***@cluster0.mhwnsc1.mongodb.net/backend-node-api`);
